...
%START% %JAVACMD% %JAVA_OPTS% -Dderby.stream.error.file=../l/derby.log -classpath %CLASSPATH% -Dapp.name="agent" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" ru.centerinform.terminal.agent.Agent %CMD_LINE_ARGS%
